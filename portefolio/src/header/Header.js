...
function Header() {
    ...
    return (
        <header className="violetalien">
            <img src={logo} className="logo" alt="Logo Piemdc"></img>

            <ul className={`navUl ${isActive ? "active" : ""}`}>
                <li className="navlink" onClick={() => mobileMenu}><a href="#/account">Présentation</a></li>
                <li className="navlink" onClick={() => mobileMenu}><a href="#">Realisations</a></li>
                <li className="navlink" onClick={() => mobileMenu}><a href="#">Contact</a></li>
